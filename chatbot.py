...
class ChatBot:
    def __init__(self,root):
        ...
        self.clear=Button(btn_frame,text="CLEAR DATA",command=self.clear,font=('arial',14,'bold'),width=10,bg='red',fg='white')
    ...
    def send(self):
        ...
        if (self.entry.get()=='hello'):
            ...
            self.text.insert(END,'\n\n'+'Bot: Subham Pandey using Python')
