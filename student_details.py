...
class Student:
    def __init__(self,root):
        ...
        #first image
        img=Image.open(r"D:\project\Images\face_recognition.jpeg")
        ...
        #second image
        img1=Image.open(r"D:\project\Images\smart-attendance.jpg")
        ...
        #third image
        img2=Image.open(r"D:\project\Images\clg.jpg")
        ...
        #background image
        img3=Image.open(r"D:\project\Images\shuats-allahabad.jpg")
        ...
        img_left=Image.open(r"D:\project\Images\girl.jpeg")
        ...
        dep_combo=ttk.Combobox(Current_course_frame,textvariable=self.var_dep,font=("times new roman",13,"bold"),state="randomly",width=20)
        dep_combo["values"]=("Select Department","Comp.Sci.","IT","Civil","Mechnical","Electrical")
        dep_combo.current(0)
        ...
        course_combo=ttk.Combobox(Current_course_frame,textvariable=self.var_course,font=("times new roman",13,"bold"),state="randomly",width=20)
        ...
        year_combo=ttk.Combobox(Current_course_frame,textvariable=self.var_year,font=("times new roman",13,"bold"),state="randomly",width=20)
        ...
        semester_combo=ttk.Combobox(Current_course_frame,textvariable=self.var_semester,font=("times new roman",13,"bold"),state="randomly",width=20)
        semester_combo["values"]=("Select Semester","Semester_1","Semester-2")
        ...
        div_combo=ttk.Combobox(class_Student_frame,textvariable=self.var_div,font=("times new roman",13,"bold"),state="randomly",width=18)
        ...
        gender_combo=ttk.Combobox(class_Student_frame,textvariable=self.var_gender,font=("times new roman",13,"bold"),state="randomly",width=18)
        ...
        img_right=Image.open(r"D:\project\Images\students.jpg")
        ...
        search_combo=ttk.Combobox(search_frame,font=("times new roman",13,"bold"),state="randomly",width=15)
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="@shubh97",database="face_recognizer")
    ...
    #=====generate dataset Take a photo samples=====
