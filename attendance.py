...
class Attendance:
    def __init__(self,root):
        ...
        #first image
        img=Image.open(r"D:\project\Images\smart-attendance.jpg")
        ...
        #second image
        img1=Image.open(r"D:\project\Images\clg.jpg")
        ...
        export_csv_btn=Button(btn_frame,text="Export csv",command=self.exportCsv,width=17,font=("times new roman",13,"bold"),bg="blue",fg="white")
    ...
    def exportCsv(self):
        try:
            if len(mydata)<1:
                ...
                return False
            fln=filedialog.asksaveasfilename(initialdir=os.getcwd(),title="Open CSV",filetypes=(("CSV Files","*.csv"),("All File","*.*")),parent=self.root)
